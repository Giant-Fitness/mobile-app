...
export const WeightChart: React.FC<WeightChartProps> = ({
    ...
    }, [yAxisRange, plotHeight, isSleepData]);
    ...
    const points = React.useMemo(() => {
            ...
            return [
                {
                    ...
                    weight: point.weight ?? point.durationInMinutes ?? 0,
        ...
        return data.map((point) => ({
            ...
            y: CHART_PADDING.top + ((yAxisRange.max - (point.weight ?? point.durationInMinutes ?? 0)) / (yAxisRange.max - yAxisRange.min)) * plotHeight,
            weight: point.weight ?? point.durationInMinutes ?? 0,
            timestamp: point.timestamp,
            originalData: point.originalData,
        }));
    }, [data, plotWidth, plotHeight, yAxisRange, chartWidth, isSleepData]);
