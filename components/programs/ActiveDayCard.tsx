...
const ActiveCard = (props) => {
    ...
    return (
        <TouchableOpacity style={[styles.container]}>
            ...
            >
                <ThemedText style={[styles.title, { color: themeColors.text }]}>Week 3 Day 2: Full Body Blast</ThemedText>
                <View style={styles.IconTextView}>
                    <Entypo name='stopwatch' size={18} color={themeColors.subText} style={{ marginRight: '2%' }} />
                    <ThemedText style={[{ color: themeColors.subText }]}>30 mins</ThemedText>
                </View>
                <View style={styles.IconTextView}>
                    <MaterialCommunityIcons name='dumbbell' size={18} color={themeColors.subText} style={{ marginRight: '2%' }} />
                    <ThemedText style={[{ color: themeColors.subText }]}>Full Gym</ThemedText>
                </View>
            </View>
        </TouchableOpacity>
    );
