...
const sampleExercises: Exercise[] = [
    {
        ...
        PhotoUrl: 'https://images.pexels.com/photos/371049/pexels-photo-371049.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
    ...
    for (let week = 1; week <= totalWeeks; week++) {
        for (let day = 1; day <= 7; day++) {
            ...
            programDays.push({
                ...
                PhotoUrl: 'https://images.pexels.com/photos/3253501/pexels-photo-3253501.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2',
                CreatedAt: `2024-07-${dayCounter < 10 ? '0' + dayCounter : dayCounter}`,
                UpdatedAt: `2024-07-${dayCounter < 10 ? '0' + dayCounter : dayCounter}`,
                Time: isRestDay ? 0 : 60,
