...
export const useProgramData = (
    ...
    useEffect(() => {
        ...
        if (programId) {
            ...
            // Conditionally fetch all program days based on options
            if (options.fetchAllDays && !specificDayId && Object.keys(programDaysState[programId] || {}).length === 0) {
        ...
        programDayState,
        programDaysState,
        options.fetchAllDays, // Updated dependency
    ]);
